...
function GeraImagem(imagem) {
    ...
    /* Obtém o diretório onde se encontra a aplicação principal e montar o diretório para obter a imagem do seu respectivo diretório.
    */
 ...
 * @param {number} acao Define o tipo de ação que o botão fará - Valores: 1(onclick); 2(onsubmit); 3(âncora/href) - OBR.
 ...
 * @returns {object} Retorna o elemento HTML do botão gerado dinâmicamente.
 * @version 1.0.0
 */
